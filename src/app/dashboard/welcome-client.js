...
export default function WelcomeClient() {
    ...
    useEffect(() => {
        ...
        const checkMobile = () => {
            ...
            // En móvil, cerrar automáticamente el sidebar
        ...
        // Agregar event listener para window resize
    ...
    // Toggle para abrir/cerrar el sidebar en móvil
    const toggleSidebar = () => {
    ...
    return (
        <div className="flex flex-col h-screen bg-gradient-to-br from-indigo-50 to-blue-50">
            ...
            <div className="flex flex-1 h-full">
                {/* Sidebar - Ahora con position fixed solo en móvil */}
                <div 
                ...
                {/* Main Content - Ahora con flex-col y overflow-hidden solo en el contenedor padre */}
                <div className="flex-1 flex flex-col">
                    {/* Navbar - Siempre visible y fijo en la parte superior */}
                    ...
                    {/* Welcome Content - Con overflow-y-auto para scroll y min-height para evitar duplicación */}
                                        ...
                                        <div className="relative p-4 sm:p-8 md:p-12 flex flex-col md:flex-row items-center">
                                            ...
                                            <div className="w-full md:w-1/2 mt-8 md:mt-0 flex justify-center items-center z-10">
                                                <div className="relative w-full max-w-xs md:max-w-md">
                                                    ...
                                                    {/* Decorative elements - visibles solo en tabletas y escritorio */}
